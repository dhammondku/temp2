...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"kontact.interface.js":[function(require,module,exports) {
'use strict';
...
var KontactInterface = function () {
    function KontactInterface() {
        _classCallCheck(this, KontactInterface);
    ...
    _createClass(KontactInterface, [{
        key: 'run',
        value: function run(_cb) {
            var _this = this;

            this.stomp.connect(this.headers, function (cb) {
                //var topic = stomp.subscribe('/presence/stream/4UeSQ', function(e) {
                var topic = _this.stomp.subscribe('/stream/8afcbb5b-7a78-4972-a775-e808f6beee9a/presence', function (e) {
                    //debugger
                    //console.log(JSON.parse(e.body));
                    var data = JSON.parse(e.body);
                    if (data && Array.isArray(data)) {
                        var filteredData = data.filter(function (i) {
                            return !i.trackingId.includes(":");
                        });
                        //console.log(filteredData)
                        filteredData.forEach(function (i) {
                            if (!_this.gateways[i.sourceId]) {
                                _this.gateways[i.sourceId] = {};
                            }

                            _this.gateways[i.sourceId][i.trackingId] = i;
                        });
    ...
    return KontactInterface;
}();

exports.default = new KontactInterface();
},{}],"gateway.detail.js":[function(require,module,exports) {
'use strict';
...
var Beacon = function Beacon(_ref) {
    var beaconId = _ref.beaconId,
        data = _ref.data;
...
var GatewayDetails = function (_React$Component) {
    _inherits(GatewayDetails, _React$Component);

    function GatewayDetails(props) {
        _classCallCheck(this, GatewayDetails);

        var _this = _possibleConstructorReturn(this, (GatewayDetails.__proto__ || Object.getPrototypeOf(GatewayDetails)).call(this, props));

        _this.renderBeacons = _this.renderBeacons.bind(_this);
        return _this;
    }

    _createClass(GatewayDetails, [{
        key: 'renderBeacons',
        value: function renderBeacons() {
            var _this2 = this;

            return Object.keys(this.props.beacons).map(function (key) {
                return _react2.default.createElement(Beacon, {
                    key: key,
                    beaconId: key,
                    data: _this2.props.beacons[key]
                });
            });
        }
    }, {
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js"}],"kontact.container.js":[function(require,module,exports) {
'use strict';
...
var _kontact = require('./kontact.interface');

var _kontact2 = _interopRequireDefault(_kontact);

var _gateway = require('./gateway.detail');
...
var KontactContainer = function (_React$Component) {
    _inherits(KontactContainer, _React$Component);

    function KontactContainer(props) {
        _classCallCheck(this, KontactContainer);

        var _this = _possibleConstructorReturn(this, (KontactContainer.__proto__ || Object.getPrototypeOf(KontactContainer)).call(this, props));
        ...
        _this.renderGateways = _this.renderGateways.bind(_this);
        return _this;
    }

    _createClass(KontactContainer, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            _kontact2.default.run(this.onUpdate);
        }
    }, {
        key: 'onUpdate',
        value: function onUpdate(gateways) {
            console.log('Gateways', gateways);
            this.setState({ gateways: gateways });
        }
    }, {
        key: 'renderGateways',
        value: function renderGateways() {
            var _this2 = this;

            if (!this.state.gateways) {
                return "Loading Gateways...";
            }
            return Object.keys(this.state.gateways).map(function (key) {
                return _react2.default.createElement(_gateway2.default, {
                    key: key + '-' + _this2.state.gateways[key].trackingId,
                    gatewayId: key,
                    beacons: _this2.state.gateways[key] });
            });
        }
    }, {
        key: 'render',
    ...
    return KontactContainer;
}(_react2.default.Component);

exports.default = KontactContainer;
},{"react":"../node_modules/react/index.js","./kontact.interface":"kontact.interface.js","./gateway.detail":"gateway.detail.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var _kontact = require('./kontact.container');
...
var App = function App() {
    return _react2.default.createElement(_kontact2.default, null);
};

_reactDom2.default.render(_react2.default.createElement(App, null), document.getElementById('root'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./kontact.container":"kontact.container.js","./app.css":"app.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/app.5c81d9ec.map